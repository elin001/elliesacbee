...
You absolutely need tidyverse and tidycensus, but I also loaded tigris to do some basic mapping at the end of the walkthrough. 
```{r}
library(tidyverse)
library(tidycensus)
library(tigris)
...
Okay, let's keep the data nationwide. Let's see which state has the highest range between info workers. 

To start to do this, I'm gonna create two different columns for male and female information workers. That's what that "spread" command is for. Next, I pipe it into  
